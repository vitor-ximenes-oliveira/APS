...
urlpatterns = [
    ...
    path('inserirDado/<int:id>',views.inserirDado,name='inserirDado'),
    path('editarDado/<int:id>',views.editarDado,name='editarDado'),
    path('excluirDado/<int:id>',views.excluirDado,name='excluirDado')
